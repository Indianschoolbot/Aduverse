...
# ------------------------------------------------
API_ID = int(os.environ.get("API_ID", "20834239"))
# ------------------------------------------------
API_HASH = os.environ.get("API_HASH","df0f365b94727a26c1b8bcddb3d7b181")
# ------------------------------------------------
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8871109208:AAFtOCsd4Mbu4macLkD5niFUcEuEDwlVc7w")
# ------------------------------------------------
BOT_USERNAME = os.environ.get("BOT_USERNAME", "@AducationStreamBot")
BOT_TEXT = "Aduverse"
# ------------------------------------------------
OWNER_ID = int(os.environ.get("OWNER_ID", "1450246428"))
# ------------------------------------------------
# //LOG CHANNEL ID 
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1003181771767"))

# //FORCE_CHANNEL_ID
CHANNEL_ID2 = int(os.environ.get("CHANNEL_ID2", "-1003181771767")) 
# ------------------------------------------------
...
# -----------------------------------------------
join = '<a href="https://t.me/+l3L1PoXWwB44MzJl">✳️ JOIN BACKUP</a>'
# -----------------------------------------------
...
THUMB_URL = os.environ.get("THUMB_URL", "https://aducation.in/wp-content/uploads/2025/09/cropped-Logo-For-Youtube.jpg")
